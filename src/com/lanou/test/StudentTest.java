...
//    初始化操作 Brfore注解:在test之前执行的方法,通常该方法中做一些初始化的操作
    @Before
    public void init(){
...
//    销毁操作 After 在test注解之后执行的方法,通常fail方法中做一些释放,关闭的操作
    @After
    public void destroy(){
...
//    数据库插入操作 Test注解:单元测试执行的方法
    ...
    public void createCriteria(){
        //获得要进行查询的Student对应的Criteria接口对象,他是比HQL更高级的查询方式
